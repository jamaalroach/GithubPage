...
> Update: As I have discovered some irregularities while pre-processing the Tweets for a corpus analysis (see the [follow-up post](https://ellocke.github.io/post/r-german-academic-twitter-pt-2-from-data-to-corpus-with-a-turkish-twist/#the-turkish-plot-twist) for details), the Sociology Twitter sample needs extra-filtering.
