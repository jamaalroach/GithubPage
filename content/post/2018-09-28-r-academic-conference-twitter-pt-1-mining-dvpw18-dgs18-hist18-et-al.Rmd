...
description: In September, four (update! - five) big academic societies in Germany had their annual meetings - all at the same time! You can **not not** harvest their tweets. I'll explain step-by-step how to mine them with rtweet and how to wrangle the Tweets for a tidy analysis.
abstract: In September, four (update! - five) big academic societies in Germany had their annual meetings - all at the same time! You can **not not** harvest their tweets. I'll explain step-by-step how to mine them with rtweet and how to wrangle the Tweets for a tidy analysis.
...
sequenceDiagrams:
  ...
  options: ''
---
# The Setting: The Big 5 on Twitter
...
>Update 3: As I've stumbled upon some irregularities in my [follow-up post](https://ellocke.github.io/post/r-german-academic-twitter-pt-2-from-data-to-corpus-with-a-turkish-twist/#the-turkish-plot-twist), it turns out the Twitter sample for the Sociology conference (esp. `#dgs2018`) has been heavily cross-poluted by some other event using the same Hashtag, but in Turkey... This has been reflected in the [follow-up post](https://ellocke.github.io/post/r-german-academic-twitter-pt-2-from-data-to-corpus-with-a-turkish-twist/#the-turkish-plot-twist), but has yet to be implemented here.
...
> Please, see `Update 3` further above. This analysis and interpretation is not valid, at the moment. See the [follow-up post](https://ellocke.github.io/post/r-german-academic-twitter-pt-2-from-data-to-corpus-with-a-turkish-twist/#the-turkish-plot-twist) for proper numbers.
...
Sociology has the highest number of active users and Favs (wow!), while PolSci has a lead with the total number of Tweets.
