---
title: '[R] German Academic Twitter, Pt. 1: Mining #dvpw18, #dgs18, #hist18 et al.'
author: Ilja / fubits
date: '2018-09-28'
categories:
  - Data Mining
...
dgs_collection %>%
  ...
  guides(fill = FALSE)
```
That looks rather different from the #dvpw2018 community. Less institutional dominance and actually, many more individual Twitter users (704 active users vs 238 in team PolSci).
...
```{r}
bind_rows(dvpw_counts, dgs_counts, hist_counts, inf_counts) %>%
  group_by(discipline) %>% 
