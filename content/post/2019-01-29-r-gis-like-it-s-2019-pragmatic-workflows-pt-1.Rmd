...
*(Mapdeck madness! Courtesy of [SymbolixAU/mapdeck](https://symbolixau.github.io/mapdeck/articles/layers.html){target="_blank"}.)*
...
And if you need to make thematic maps and/or don't want to plot your spatial objects with `ggplot`, have a look at Martijn Tennekes's `tmap`, which is also very well covered by Lovelace 2018 [Lovelace/Nowosad/Muenchow 2018](https://geocompr.robinlovelace.net/adv-map.html#tmap-basics), and gives you a lot with very few lines:
