...
output:
  blogdown::html_page:
    number_sections: yes
    toc: yes
description: 'TL;DR: I had to figure out how to debug() Hugo / my Blogdown page on
  Windows 10 and came up with 3 methods. Besides, I''ve documented some common not-Windows-specific
  errors / troubles with Blogdown / Hugo'
comment: no
autoCollapseToc: no
postMetaInFooter: no
...
>**Besides, I've documented [some common _not-Windows-specific_ errors / troubles with Blogdown / Hugo](#some-other-common-errors-troubles-with-blogdownhugo) which are hard to Google somehow, but far more easier to solve:\
> \>\>\> [Dealing with *config.toml*, *seImpl()* & *tomlparseImpl()* errors](#some-other-common-errors-troubles-with-blogdownhugo)**
...
# Some other common Errors / Troubles with Blogdown/Hugo
